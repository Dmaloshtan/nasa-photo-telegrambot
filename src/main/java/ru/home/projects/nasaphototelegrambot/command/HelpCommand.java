...
public class HelpCommand implements Command {
    ...
    public final static String HELP_MESSAGE = String.format("\uD83E\uDE90<b>Доступные команды</b>\uD83E\uDE90\n\n"
                    ...
                    "Нажав на данную команду вы сможете получить \"Фото дня\".\n\n"
                    ...
                    "куда попадают, как красивые снимки рельефа Марса, так и случайные искажения" +
                    " в камере. При нажатии на данную команду вы получите сразу серию из " +
